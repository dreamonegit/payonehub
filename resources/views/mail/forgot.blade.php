                     ...
                     <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                           <td align="center" style="background-color: #e7e7e7;">
                              ...
                              <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;"><strong>Hi there!
</strong></span></p>
...
<a href="#">Your password is </a> {{ $password }} .
</br>
                              ...
                              <p style="font-size: 14px; line-height: 170%;">&nbsp;</p>
                               ...
                               <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">PayOneHub Care Team &nbsp;</span></p>                              </div>
                              </td>
                              </tr>
                              </tbody>
                              </table>
                              ...
                              <tr>
                              <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                              <img align="center" border="0" src="{{ asset('assets/img/email.jpeg') }}" alt="Icon" title="Icon" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 48%;max-width: 107.04px;     margin-top: -22px;" width="107.04" class="v-src-width v-src-max-width"/>
                              </td>
                              </tr>
                              </table>
                              </td>
