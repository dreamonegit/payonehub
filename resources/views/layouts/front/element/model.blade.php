...
<div id="login-forgot" class="modal fade" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content p-sm-3">
	  <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="tab-content pt-4">
          <div class="tab-pane fade" id="forgot-content" role="tabpanel" aria-labelledby="forgot-content-tab">
		  <span class="throw_log_error"></span>
		  <span class="throw_log_success"></span>
            <form id="forgotForm" method="post">
              <div class="form-group">
                <input type="text" class="form-control" id="forgotmail" name="forgotmail" required placeholder="Email ID">
			  </div>
			  <span class="throw_error"></span>
			  <span class="throw_success"></span>
