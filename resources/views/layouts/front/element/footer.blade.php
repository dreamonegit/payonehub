  ...
  <footer id="footer" class="mt-0">
    <section class="section bg-primary shadow-md pt-4 pb-3">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-3">
            <div class="featured-box text-center">
              <div class="featured-box-icon text-light"> <i class="fas fa-lock"></i> </div>
              <h4 class="text-light">100% Secure Payments</h4>
              <p class="text-light">Moving your card details to a much more secured place.</p>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="featured-box text-center">
              ...
              <p class="text-light">100% Payment Protection. Easy Return Policy.</p>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="featured-box text-center">
              ...
              <p class="text-light">Invite a friend to sign up and earn up to $100.</p>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="featured-box text-center">
              ...
              <p class="text-light">We're here to help. Have a query and need help ? <a href="#" class="text-light">Click here</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt-4">
      <div class="row">
        ...
        <div class="col-md-2 mb-3 mb-md-0">
          <p>Digital Payment</p>
           <ul class="payments-types">
            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('assets/front/images/payment/bitron_payment.png') }}" alt="visa" title="Visa"></a></li>
          </ul>
        </div>
    ...
    <div class="container">
      <div class="footer-copyright">
        ...
        <p class="copyright-text">Copyright © 2022 <a href="#">PayONEHub</a>. All Rights Reserved.</p>
      </div>
    </div>
  </footer>
  <!-- Footer end --> 
